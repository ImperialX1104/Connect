...
<main id="main">
                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-md-7 text-center hero-text">
                            ...
                            <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Find Love Amongst Friends:
                                Connecting Hearts with 'Connect'.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-4">
        ...
        <p>Welcome to Connect-App!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Connect-App's Website,
            located at connect-app.in</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Friend
            for you if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing Connect-App, you agreed to use cookies in agreement with
            the Connect-App's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Connect-App and/or its licensors own the intellectual property rights for all
            material on Connect-App. All intellectual property rights are reserved. You may access this from
            Connect-App for your own personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from Connect-App</li>
            <li>Sell, rent or sub-license material from Connect-App</li>
            <li>Reproduce, duplicate or copy material from Connect-App</li>
            <li>Redistribute content from Connect-App</li>
        </ul>


        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. Connect-App does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and opinions of Connect-App,its
            agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Connect-App shall not be liable for the
        ...
        <p>Connect-App reserves the right to monitor all Comments and to remove any Comments which can be
        ...
        <p>You hereby grant Connect-App a non-exclusive license to use, reproduce, edit and authorize others to
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            absence of Connect-App; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to Connect-App. Please include your name, your
        ...
        <p>No use of Connect-App's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
